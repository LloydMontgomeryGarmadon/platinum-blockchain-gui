      ...
      submenu: [
        {
          ...
          click: () => {
            openExternal('https://github.com/LloydMontgomeryGarmadon/cryptomines-blockchain/releases');
          },
        },
        {
          type: 'separator',
        },
        {
          ...
          click: () => {
            openExternal('https://github.com/LloydMontgomeryGarmadon/cryptomines-blockchain/issues');
          },
        },
        {
