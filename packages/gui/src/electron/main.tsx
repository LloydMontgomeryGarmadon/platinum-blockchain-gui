      ...
      submenu: [
        {
          ...
          click: () => {
            openExternal('https://github.com/LloydMontgomeryGarmadon/platinum-blockchain/releases');
          },
        },
        {
          type: 'separator',
        },
        {
          ...
          click: () => {
            openExternal('https://github.com/LloydMontgomeryGarmadon/platinum-blockchain/issues');
          },
        },
        {
