...
import { useGetKeyringStatusQuery } from '@platinum/api-react';
import {
  Button,
  AlertDialog,
  Suspender,
          ...
          <Flex gap={1} alignItems="center">
            ...
            <TooltipIcon>
              <Trans>
                ...
                number is generally higher if you have a lot of transactions or canceled offers for PLAT, CATs, or NFTs.
